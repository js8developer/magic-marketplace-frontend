...
const MarketItemDetails = ({ wallet, marketItems, ethPrice, maticPrice }) => {
                            ...
                            <div>
                                ...
                                { (nft.seller.toLowerCase() === wallet.toLowerCase()) && 
                                    <div className='space-y-4'>
                                        ...
                                        { (deleting === false) &&
                                            <button onClick={deleteListing} className="h-12 w-44 inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-red-500 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200">Delete Listing</button>
                                        }
                                        { (deleting === true) &&
